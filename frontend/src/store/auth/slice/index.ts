...
export const registerAdmin = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const error = err as AxiosError<{ password?: string[]; message?: string }>;

      return thunkAPI.rejectWithValue(error.response?.data || { message: 'Registration failed, check your details' });
    }
  }
);
